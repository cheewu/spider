...
#                                     },
    ...
    "daodaoSpider":{
        ...
        'normalRegex':[
            {    
        #列表：热门旅游目的地，如：http://www.daodao.com/Tourism-g294212-Beijing-Vacations.html
                'regex':r'Tourism-g\d+-.+-Vacations\.html$', 
                'priority':10
            },
            {    
        #列表：景点，如：http://www.daodao.com/Attractions-g294212-Activities-Beijing.html
                'regex':r'Attractions-g\d+-Activities-.*\.html$', 
                'priority':50
            },
            {
        #列表：热门旅游目的地、最新点评旅游目的地、热门标签，如：
        #http://www.daodao.com/Tourism-g298555-c0-Guangzhou_Guangdong.html
        #http://www.daodao.com/Tourism-g298555-c0-Guangzhou_Guangdong.html?kw=%E9%A3%8E%E6%99%AF&st=8
        #http://www.daodao.com/Tourism-g298555-c0-Guangzhou_Guangdong.html?pg=2
        'regex':r'Tourism-g\d+-c\d+-.*\.html((\?pg=\d+)?|(\?kw=.*&st=8)?)$',  #包括游记列表、标签
                'priority':50
            } 
        ],
        #item页正则表达式 itemCollectionName对应item存放的数据表名
        'itemRegex':[
            #AttractionItem
            {
        #文章：旅游景点，如：http://www.daodao.com/Attraction_Review-g294212-d1937429-Reviews-Jiudaowan_Hutong-Beijing.html
            ...
            #NoteItem
            {
        #文章：旅游攻略，如：http://www.daodao.com/Tourism-g298555-c2-n1567138_Meishi.html
            ...
            #CommonSenseItem
            {
        #文章：旅游常识，如：http://www.daodao.com/Changshi-g294212-Beijing_Wenhua.html
